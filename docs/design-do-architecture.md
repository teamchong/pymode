...
`scripts/bundle-project.py`). Legacy mode is preserved for backwards compatibility.
...
| `scripts/bundle-project.py` | Bundle user .py files → user-files.ts |
| `scripts/build-phase2.py` | Build CPython WASM with zig cc + Asyncify |
