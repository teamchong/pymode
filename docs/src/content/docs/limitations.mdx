...
| Package | Variant in repo | Verified deployable today |
|---|---|---|
| numpy | ✅ `python-numpy.wasm` | ✅ (linalg stubbed — see below) |
| Pillow | ✅ `python-pillow.wasm` | needs verification pass |
| pydantic_core | ✅ `python-pydantic-core.wasm` | needs verification pass |
| markupsafe | ✅ statically linked | yes |
| regex / msgpack / xxhash | ✅ statically linked | yes |
| pandas | ❌ | no |
| scipy | ❌ | no |
| scikit-learn | ❌ | no |
| lxml | ❌ | no |
