...
// User site-packages (PyPI deps from `pymode install`) are staged to the
// ASSETS binding at deploy time so they don't eat into the 10 MiB worker
// bundle cap. The bytes are fetched lazily via warmSitePackages(env) in
